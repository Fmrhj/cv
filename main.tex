...
\usepackage{enumitem}
\setlist[itemize]{label={\tiny\raisebox{1ex}{\textbullet}}, 
        labelsep=4pt, 
        itemsep=0.5pt, 
        before=\normalfont\small, 
        indent=0pt, 
...
\begin{document}
	...
	\begin{tabular}{L!{\VRule}R}
		...
		\berlin & \sbt Engineering Lead and Data Engineer with a strong focus on the energy sector.\\
            ...
            \fromBis{07/20}{02/22} & \jobTitle{Data Engineer and Senior Analytics Consultant} - \companyName{\qurix}\\
