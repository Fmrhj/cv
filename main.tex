...
\begin{document}
	...
	\begin{tabular}{L!{\VRule}R}
		...
		\berlin & \sbt Backend Engineer in analytics projects for data analytics and AI projects for commercial vehicles.\\
                    & \sbt Implementing data services for busines.\spaceBetweenCvEntry
		...
		\fromBis{09/16}{06/20} &\jobTitle{Data Scientist and Data Engineer} - \companyName{\lsy}\\
		\berlin & \sbt Specialized in airline revenue management and pricing with a strong emphasis on operations research, data engineering, predictive analytics and machine learning.\\
                  ...
                  & \sbt Conceptualized and prototyped dynamic bundling and pricing strategies for flight ancillaries\\
                  & \rule{\columnwidth}{0.5pt} \\
                  & \sbt Masterand and Student Assistant: Expertise in ML-driven passenger demand estimation and bid price optimization. Master's thesis on "Airline Stochastic Dynamic Pricing Model": Reinforcement Learning for optimal pricing strategies in single-leg flights.
                ...
                \parbox{0.49\linewidth}{
                     \begin{flushleft}
        				...
        				\item Data Architecture: Microservices, Lambda, Mesh
                            ...
                            \item Orchestration: Airflow, Azure Data Factory, AWS Glue
                            \item Big Data: PySpark (Databricks), Kafka (Confluent)
                            \item Other Skills: effective communication, cultural awareness, teamwork
                        \end{enumerate}
	       	   \end{flushleft}
                }}
