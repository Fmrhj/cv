...
\begin{document}
    ...
    \begin{multicols}{2}
    \begin{itemize}[parsep=0pt, topsep=0pt, itemsep=1.0pt, leftmargin=1.2em]
      ...
      \item \textbf{ETL}: Airflow, Databricks, Apache Spark, Azure Data Factory, AWS Step Functions.
        \item \textbf{Real-time}: Event-driven architectures with e.g. Apache Kafka (Confluent), Azure Event Grid, AWS Kinesis, SQS.
      \item \textbf{Data Warehousing}: Snowflake, Redshift, BigQuery, Azure Synapse.
    ...
    %---- Languages %
    \cvSection{Languages} \hspace{0.1cm}
    {\small
